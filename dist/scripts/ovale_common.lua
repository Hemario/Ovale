...
Define(crest_of_paku 165581)
    ItemInfo(crest_of_paku unusable=1)
...
Define(breath_of_the_dying_essence_0 310690)
    SpellInfo(breath_of_the_dying_essence_0 tag=main cd=45)
Define(concentrated_flame_essence_0 295373)
    SpellInfo(concentrated_flame_essence_0 cd=30 tag=main)
    Define(concentrated_flame_burn_debuff 295368)
    SpellInfo(concentrated_flame_burn_debuff duration=6)
    SpellAddTargetDebuff(concentrated_flame_essence_0 concentrated_flame_burn_debuff=1)
SpellList(concentrated_flame_essence concentrated_flame_essence_0 breath_of_the_dying_essence_0)
