...
Define(avenging_crusader 216331)
    ...
    SpellRequire(avenging_crusader unusable 1=buff,avenging_crusader_buff)
Define(avenging_crusader_buff 216331)
    ...
    SpellRequire(avenging_wrath unusable 1=buff,avenging_wrath_buff)
...
Define(consecration_retribution 205228)
    ...
    SpellRequire(crusade unusable 1=buff,crusade_buff)
...
Define(judgment_holy_debuff 214222)
	SpellInfo(judgment_holy_debuff duration=15)
    SpellAddTargetDebuff(judgment judgment_holy_debuff=1 specialization=holy)
    SpellAddTargetDebuff(holy_shock judgment_holy_debuff=0 specialization=holy)
    SpellAddTargetDebuff(crusader_strike judgment_holy_debuff=0 specialization=holy)
